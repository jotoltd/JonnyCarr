                  ...
                  <section className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        {featuredRaffle.ends_at && (
                          <CountdownTimer endDate={featuredRaffle.ends_at} />
                        )}
                      </div>
                    </div>
                    ...
                    {/* Social Sharing */}
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 border-t border-brand-cream-border">
                      <span className="text-sm text-brand-green flex items-center gap-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-brand-cream-light border border-brand-cream-border rounded-lg text-sm text-brand-green-dark hover:bg-brand-cream transition-colors"
                        >
                          <Link2 className="w-4 h-4" />
                          Copy Link
                        </button>
                        <a
                          href={`https://twitter.com/intent/tweet?text=Enter to win: ${encodeURIComponent(featuredRaffle.title)}&url=${encodeURIComponent(window.location.href)}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#1DA1F2] text-white rounded-lg text-sm hover:opacity-90 transition-opacity"
                        >
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#4267B2] text-white rounded-lg text-sm hover:opacity-90 transition-opacity"
                        >
